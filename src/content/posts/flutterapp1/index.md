...
:::
畫面截圖
![](./version1/1_XLnlzADYdaJPWFxhwzj6Jg.webp)
...
![](./version1/1_4jZO1Mm5Ge36hssKGO5kRg.webp)
...
:::
軟體畫面與使用效果截圖：
![](./version2/1_ARmSvKJB1noxL7Q_VCpzmA.webp)
看一下 server 的 console:
![](./version2/1_J2blSCxbrsvUkdd9H1Zj8g@2x.webp)
...
![](./version3/1_N87R_JNThR4WwOn46KMkog@2x.webp)
我嘗試下了一個 prompt：
:::tip[PROMPT]
...
![](./version3/1_zhOjv_-SLJMbbAlmKWMCUg@2x.webp)
...
![](./version3/1_ZIdLgCNwO6gHMuSwusYlhw@2x.webp)
...
![](./version3/1_IrAnuPhAXnsgL59Ex__1EA@2x.webp)
點進去後，發現了關鍵線索：
![](./version3/1_4ib5EbDgSzn31TPVTrXF2Q@2x.webp)
...
![](./version3/1__6rfRkNherFRjqxYtggLaA@2x.webp)
在這就可以跟著範例直接將正確程式碼寫入，寫好正確程式碼後，再透過註解插入法請 AI 插入個 Toast 的程式碼，讓連線成功時會顯示 Toast。
![](./version3/1_4cIEQ4CyKODAjQfd4qwqpw@2x.webp)
此時提示出現了：
:::note
...
:::
無法連線效果：
![](./version3/1__VFWwKGivdL0Q5Y0PmZ2HQ.gif)
最後看出來怎麼搞個 Toast 後，最後自己也針對沒連線或沒輸入訊息的狀況新增了 Toast：
![](./version3/1_2NFrofb38W4usbY2DpnPAw.gif)
...
原始 AI 寫的：
![](./version3/1_IdkMzhmUbrFZNLT7wlc4xQ@2x.webp)
然後下了這版最後一個 prompt，讓 Toast 顯示時間短一點：
:::tip[PROMPT]
Change all toast display time to 2 secs
:::
最終效果（無法連線的部分就不展示了）：
![](./version3/1_xjALUMcvowPO5QoMWV_odw.gif)
...
![](./version6/1_SBqCN81QXwr5MYb6sWBGSQ.webp)
...
![](./version6/1_PijasVI1UFtgRdeVpQaQBw@2x.webp)
因為真的不知道怎樣再下 prompt 了，所以只能看官方文件範例開改，這 AI 感覺有點……
![](./version6/1_n8Ek8-aMv04C8QN7Ms_nqg@2x.webp)
中途我知道你想幫我，但不好意思，我想用比較保險的官方做法
![](./version6/1_Y5-P4qhHduFgUA_3ZLrw0g@2x.webp)
效果：
![](./version6/1_f7MIwJXLlJpcNOlZ7dGFtw.gif)
接下來就是字型，照著老師給的文章設定，然後下 prompt 請 AI 幫我換：
:::tip[PROMPT]
Add font to all text
:::
結果全數報錯， 請問 AI 你資料還太少嗎？
![](./version6/1_cWj6D6lbme0Eq4nEarEl5w@2x.webp)
所以只能先接受，然後自己看 docs 換，超大一坨
![](./version6/1_WaoSvkC9ASvmKT9-u3PGeQ@2x.webp)
但到後面我才不知道為什麼自己剛剛要那樣做
![](./version6/1_QIdX_l1uPOBhIpunbg3NnA@2x.webp)
到後面才發現官方其實有寫怎麼套全域字體，所以後來自己就把套字體方式換成 docs 上面寫的了
套用字型後效果可以說是非常好
![](./version6/1_dojWjHG936DMhrNNmDb57Q.webp)
最後自己換個不錯的顏色
![](./version6/1_I3EYyIfeGRcjU8-9jCy4hw.webp)
